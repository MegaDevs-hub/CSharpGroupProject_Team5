...
Project description: A form and the code that converts Celsius to Fahrenheit and vice versa.  Buttons display the names of the developers.

How to run: Press F5 in Visual Studio

Members and contributors: pitchert1, RooneyA3, waupoosa1, pearson23
